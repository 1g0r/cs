...
namespace Mindscan.Media.HtmlParser.Tests.Commands
{
	[Category("Commands")]
	[TestFixture]
	internal class TakeLastTests : ParserTestsBase
	{
		...
		{
			//Arrange
			var command = SupportedCommands.TakeLast();
		...
		[TestCase("<div> <p></p> <p class='gotcha'>waffle</p> <p class='gotcha'>foo</p> </div>", "foo", ".gotcha", ".gotcha")]
		[TestCase("<div> <p></p> <p class='gotcha'>waffle</p> <p class='gotcha'>foo</p> </div>", "foo")]
		[TestCase("<div> <p></p> <img></img> <p class='gotcha'>waffle</p> <p class='gotcha'>foo</p> </div>", "foo", ".gotcha", "img")]
		...
		[TestCase("<div> <p></p> <p class='gotcha'>waffle</p> <p class='gotcha'>foo</p> </div>", "foo", "*[@class='gotcha']", "*[@class='gotcha']")]
		[TestCase("<div> <p>waffle</p> <p class='gotcha'>foo</p> <p class='gotcha'>foo</p> </div>", "foo")]
		[TestCase("<div> <p></p> <img></img> <p class='gotcha'>waffle</p> <p class='gotcha'>foo</p> </div>", "foo", "*[@class='gotcha']", "img")]
